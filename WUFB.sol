...
contract Consts {
    ...
    string public constant TOKEN_NAME = "WUFB";
    string public constant TOKEN_SYMBOL = "WUFB";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = TNNEeRw3LNAJraUKPLsbrmUxrJuJAdhuKA;
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Pausable {
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(TNNEeRw3LNAJraUKPLsbrmUxrJuJAdhuKA)];
        uint[1] memory amounts = [uint(21000000000000)];
